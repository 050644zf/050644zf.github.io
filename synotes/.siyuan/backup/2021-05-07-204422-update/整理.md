...
### 最小 $l_1$ 范数法
{: id="20210507154540-0iflcpi" updated="20210507204132"}
...
追求局部最优，计算速度较快。
{: id="20210507204245-blj2gae"}

{: id="20210507204255-120xmbq"}
...
### 子空间追踪 SP
{: id="20210507172522-ui5k5yi" updated="20210507203740"}

{: id="20210507203741-r3yiocp"}
...
{: id="20210507202849-3bn4q7z"}

## 凸松弛类算法
{: id="20210507154213-7f7r72u" updated="20210507154216"}

{: id="20210507204121-rqxbyfo"}
